...
public final class RedisUtil{
    ...
    public void del(String... key) {
        log.debug("del redis key: " + Arrays.toString(key));
...
//    public long multiSet(List<String> keys){
//        return redisTemplate.opsForValue().multiSet(keys);
//    }
    /**
     * 获取list缓存的长度
     * @param key 键
...
//    private void batchCacheMarketInfo(Map key, long expire) {
//        //使用pipeline方式
